...
func (_c *DiscordMessageCreate) SetNillableTimestamp(v *time.Time) *DiscordMessageCreate {
	if v != nil {
		_c.SetTimestamp(*v)
	}
	return _c
...
func (_c *DiscordMessageCreate) SetMentions(v []string) *DiscordMessageCreate {
	_c.mutation.SetMentions(v)
	return _c
}

// SetCreatedAt sets the "created_at" field.
func (_c *DiscordMessageCreate) SetCreatedAt(v time.Time) *DiscordMessageCreate {
	_c.mutation.SetCreatedAt(v)
	return _c
}

// SetNillableCreatedAt sets the "created_at" field if the given value is not nil.
func (_c *DiscordMessageCreate) SetNillableCreatedAt(v *time.Time) *DiscordMessageCreate {
	if v != nil {
		_c.SetCreatedAt(*v)
	}
	return _c
...
func (_c *DiscordMessageCreate) SetChannelID(id string) *DiscordMessageCreate {
...
func (_c *DiscordMessageCreate) defaults() {
	if _, ok := _c.mutation.Timestamp(); !ok {
		v := discordmessage.DefaultTimestamp()
		_c.mutation.SetTimestamp(v)
	}
	if _, ok := _c.mutation.CreatedAt(); !ok {
		v := discordmessage.DefaultCreatedAt()
		_c.mutation.SetCreatedAt(v)
	}
}
...
func (_c *DiscordMessageCreate) check() error {
	...
	if _, ok := _c.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent: missing required field "DiscordMessage.created_at"`)}
	}
...
func (_c *DiscordMessageCreate) createSpec() (*DiscordMessage, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.Mentions(); ok {
		_spec.SetField(discordmessage.FieldMentions, field.TypeJSON, value)

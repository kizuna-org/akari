...
func (m *MockConversationRepository) CreateConversation(ctx context.Context, messageID string, userID int, conversationGroupID *int) (*domain.Conversation, error) {
	m.ctrl.T.Helper()

...
func (i *discordInteractorImpl) SendMessage(ctx context.Context, channelID string, content string) (*entity.Message, error) {
...
func (i *discordInteractorImpl) GetMessage(ctx context.Context, channelID string, messageID string) (*entity.Message, error) {

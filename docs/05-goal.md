...
> （→ [01. 原則1](./01-vision.md) / [12.6](./12-persona.md)）。
> なお「やり通す強さ」と「諦めの早さ」は別の軸です。
...
- **自分で抱いた願い**：「〇〇が得意になりたい」「あの人ともっと話したい」のような、
  誰にも頼まれていない長期の望み。人がそうであるように、Akari も自分で願いを持ちます。

`hu.` 誰に言われたわけでもないが、うまくなりたいと思っている
...
**やり通す強さ・諦めの早さ・同時に持てる意図の数・関心と目標の配分**は、
[12. 人格パラメータ](./12-persona.md) の調整軸として外に出しました。

> **ここで確定した点**：「やり通す強さ」と「諦めの早さ」は**別の軸**にします。
> 一本にまとめると、「粘るが駄目なら早い」人も「すぐ気が散るのに手放せない」人も
> 作れなくなるためです。

本書に残る未決はありません。

- **目標の自己生成** → **持ちます**（人間準拠 → [01. 1.3](./01-vision.md)）。
  人は「〇〇が得意になりたい」と自分で思います。これを禁じると、
  願い（5.2）が他人から与えられたものだけになり、主体性が消えます。
  性格固定（[原則7](./01-vision.md)）とは衝突しません。**願いを持つことと、
  性格が変わることは別**だからです。長期的な願いを抱えたまま、揺れ方の癖は変わりません。
